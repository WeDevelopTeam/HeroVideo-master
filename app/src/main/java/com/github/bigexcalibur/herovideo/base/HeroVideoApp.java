...
public class HeroVideoApp extends Application implements ThemeUtils.switchColor{

    public static HeroVideoApp mInstance;
    ...
    public static HeroVideoApp getInstance()
    {
