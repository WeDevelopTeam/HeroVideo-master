...
public class MediaPlayer {
    ...
    private final MediaPlayerView videoView;
    ...
    public MediaPlayer(final Activity activity) {
        try {
            IjkMediaPlayer.loadLibrariesOnce(null);
            IjkMediaPlayer.native_profileBegin("libijkplayer.so");
            playerSupport=true;
        } catch (Throwable e) {
            Log.e("MediaPlayer", "loadLibraries error", e);
        }
        this.activity=activity;
        screenWidthPixels = activity.getResources().getDisplayMetrics().widthPixels;
        $=new Query(activity);
        videoView = (MediaPlayerView) activity.findViewById(R.id.video_view);
...
//                        Toaster.show("download rate:" + extra);
    ...
    /**
     * using constants in MediaPlayer,eg: MediaPlayer.SCALETYPE_FITPARENT
     * @param scaleType
     */
     ...
     */
    public MediaPlayer seekTo(int msec, boolean showControlPanle){
    ...
    public MediaPlayer forward(float percent) {
    ...
    public MediaPlayer onError(OnErrorListener onErrorListener) {
        this.onErrorListener = onErrorListener;
        return this;
    }

    public MediaPlayer onComplete(Runnable complete) {
        this.oncomplete = complete;
        return this;
    }

    public MediaPlayer onInfo(OnInfoListener onInfoListener) {
        this.onInfoListener = onInfoListener;
        return this;
    }

    public MediaPlayer onControlPanelVisibilityChang(OnControlPanelVisibilityChangeListener listener){
     ...
     * @return
     */
    public MediaPlayer live(boolean isLive) {
        this.isLive = isLive;
        return this;
    }

    public MediaPlayer toggleAspectRatio(){
        if (videoView != null) {
            videoView.toggleAspectRatio();
        }
        return this;
    ...
    public MediaPlayer onControlPanelVisibilityChange(OnControlPanelVisibilityChangeListener listener){
        this.onControlPanelVisibilityChangeListener = listener;
        return this;
    }
